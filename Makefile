...
pkgdatadir = $(datadir)/QuantLib
pkgincludedir = $(includedir)/QuantLib
pkglibdir = $(libdir)/QuantLib
pkglibexecdir = $(libexecdir)/QuantLib
...
DIST_COMMON = $(srcdir)/Makefile.am $(top_srcdir)/configure \
	$(am__configure_deps) $(am__dist_lisp_LISP_DIST) \
	$(dist_m4data_DATA) $(am__DIST_COMMON)
am__CONFIG_DISTCLEAN_FILES = config.status config.cache config.log \
 configure.lineno config.status.lineno
mkinstalldirs = $(install_sh) -d
CONFIG_HEADER = $(top_builddir)/ql/config.hpp
CONFIG_CLEAN_FILES = quantlib-config QuantLib.spec quantlib.pc
...
DATA = $(dist_m4data_DATA) $(nodist_pkgconfig_DATA)
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/QuantLib.spec.in \
	$(srcdir)/quantlib-config.in $(srcdir)/quantlib.pc.in \
...
ACLOCAL = ${SHELL} /home/aashaka/QuantLib-1.9/config/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/aashaka/QuantLib-1.9/config/missing autoconf
AUTOHEADER = ${SHELL} /home/aashaka/QuantLib-1.9/config/missing autoheader
AUTOMAKE = ${SHELL} /home/aashaka/QuantLib-1.9/config/missing automake-1.15
AWK = mawk
BOOST_INCLUDE = 
BOOST_INTERPROCESS_LIB = 
BOOST_LIB = 
BOOST_THREAD_LIB = 
...
LT_SYS_LIBRARY_PATH = 
MAKEINDEX = 
MAKEINFO = ${SHELL} /home/aashaka/QuantLib-1.9/config/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
STRIP = strip
VERSION = 1.9
abs_builddir = /home/aashaka/QuantLib-1.9
abs_srcdir = /home/aashaka/QuantLib-1.9
abs_top_builddir = /home/aashaka/QuantLib-1.9
abs_top_srcdir = /home/aashaka/QuantLib-1.9
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/aashaka/QuantLib-1.9/config/install-sh
...
QuantLib.spec: $(top_builddir)/config.status $(srcdir)/QuantLib.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
quantlib.pc: $(top_builddir)/config.status $(srcdir)/quantlib.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
installdirs-am:
	for dir in "$(DESTDIR)$(bindir)" "$(DESTDIR)$(lispdir)" "$(DESTDIR)$(m4datadir)" "$(DESTDIR)$(pkgconfigdir)"; do \
...
uninstall-am: uninstall-binSCRIPTS uninstall-dist_lispLISP \
	uninstall-dist_m4dataDATA uninstall-nodist_pkgconfigDATA
